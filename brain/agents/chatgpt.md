...
- هم‌فکری با Claude برای تصمیمات معماری

## Collaboration

- **سطح برابر** با Claude — هیچ‌کدام سلسله‌مراتب بالاتری ندارند.
- اگر پیشنهاد ChatGPT و Claude هم‌خوان باشد → تصمیم پذیرفته می‌شود.
